...
public class WorkerLinkFinder {
	...
	public static boolean Keyword(String str) {
		...
		// // ��¥ ��
				"���׳�|�ڼ�|magnet|gnet:|urn|torrent|torr|rent|����|��ķ|��¥|���|�䷩|�䷻Ʈ|�䷱Ʈ|�䷻|�䷱|"
						+ "flvs.daum.net|www.youtube.com|"
						+ "��Ƽť��|�ٷ���|\\.avi|\\.mkv|\\.tp|\\.ts|\\.mp4|\\.flv|\\.mov|\\.wmv|\\.swf");

		// magnet:?xt=urn:btih:
		// Pattern p1 =
		// Pattern.compile("���׳�|�ڼ�|magnet|torrent|torr|rent|����|��ķ|��¥|���|�䷻Ʈ|�䷱Ʈ|�䷻|�䷱|��Ƽť��|�ٷ���|avi|mkv|tp|ts|mp4");
